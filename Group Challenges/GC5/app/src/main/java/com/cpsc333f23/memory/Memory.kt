package com.cpsc333f23.memory

import kotlin.random.Random
import androidx.appcompat.app.AppCompatActivity
import com.cpsc333f23.gc5.R
...
class Memory (private var tiles: Int = 6, context: AppCompatActivity) {

    private val defaultBoardValue = context.getString(R.string.default_card_icon)

    private var totalNumberOfMatches = tiles / 2

    var matches: MutableMap<Int, Boolean> = mutableMapOf()

    var board = MutableList<String>(totalNumberOfMatches * 2) { defaultBoardValue }
