...
class MainActivity : AppCompatActivity(), WinConditionDialogFragment.OnWinConditionSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerForContextMenu(findViewById(R.id.app_game))
        ...
        title = findViewById(R.id.app_game)
    ...
    override fun onCreateContextMenu(menu: ContextMenu?, v: View?, menuInfo: ContextMenu.ContextMenuInfo?) {
        ...
        menuInflater.inflate(R.menu.card_context, menu)
    }
    ...
    private fun updateBoardDefaultIcon() {
